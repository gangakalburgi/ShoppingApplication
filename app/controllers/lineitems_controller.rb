...
skip_before_action :authorize
  ...
  def create
    ...
    respond_to do |format|
      if @lineitem.save
        format.html { redirect_to shopper_url, notice: 'lineitem was updated'} 
        format.js
  ...
  def update
    respond_to do |format|
      if @lineitem.update(lineitem_params)
        format.html { redirect_to @lineitem, notice: 'Product was successfully updated.' }
  ...
  def destroy
    @lineitem.destroy
    respond_to do |format|
      format.html { redirect_to lineitems_url, notice: 'Product was successfully deleted.' }
